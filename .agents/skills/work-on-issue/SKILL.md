...
```bash
.Codex/scripts/worktree-create.sh issue-<NUMBER>-<short-description>
```
...
```bash
cd .worktrees/issue-<NUMBER>-<short-description> && bash .Codex/hooks/tdd-state.sh activate <NUMBER>
```
