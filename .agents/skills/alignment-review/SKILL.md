...
1. **Run automated checks first**:
   - Execute `bash .Codex/hooks/lint.sh` - capture lint issues
   - Execute `bash .Codex/hooks/check-debug.sh` - capture debug code

2. **Read alignment documents**:
   - `.Codex/docs/PRINCIPLES.md` - design principles
   - `.Codex/docs/INVARIANTS.md` - system invariants
